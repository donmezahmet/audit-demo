        ...
        >
          ...
          <div className="bg-gradient-to-r from-purple-600 to-violet-600 px-6 py-4 rounded-t-2xl flex-shrink-0">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={onClose}
                className="text-white hover:text-purple-200 transition-colors p-1.5 rounded-lg hover:bg-white/10"
              >
            ...
            {isLoading ? (
              ...
              <div className="space-y-2">
                {filteredActions.map((action, idx) => (
                  <div
                    key={action.key || idx}
                    className="border border-gray-200 rounded-lg p-3 hover:shadow-md transition-all duration-200 hover:border-purple-300 bg-white"
                  >
                    {/* Header Row */}
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 font-mono font-bold text-sm">{action.key}</span>
                        <Badge variant={
                      ...
                      {/* Jira link removed in demo version */}
                    </div>
