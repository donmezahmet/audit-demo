...
export function useAuditProjectsByYear() {
  return useQuery({
    queryKey: ['audit-projects-by-year'],
    queryFn: () => jiraService.getAuditProjectsByYear(),
    ...defaultQueryOptions,
  });
}

// Hook for investigation counts
export function useInvestigationCounts() {
  return useQuery({
    queryKey: ['investigation-counts'],
    queryFn: () => jiraService.getInvestigationCounts(),
    ...defaultQueryOptions,
  });
}
...
export function useDepartmentFindingActions(filters?: { auditYear?: string }) {
  return useQuery({
...
export function useTeamFindingActions(filters?: { auditYear?: string }) {
  return useQuery({
